...
use App\Controllers\API\PostAPI;
...
// start API routes
$routes->post('/api/login', [AuthAPI::class, 'login']); // done
$routes->post('/api/register', [AuthAPI::class, 'register']); //done
$routes->post('/api/addPost', [PostAPI::class, 'addPost'],['filter' => 'auth']); //done
